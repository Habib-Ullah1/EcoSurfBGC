...
- `scripts/*.py` — Python scripts for parsing antiSMASH/Big-SCAPE outputs and automation
- `scripts/*.sh` — Shell scripts for genome downloads, antiSMASH runs, and workflow orchestration
